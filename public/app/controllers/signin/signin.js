    ...
    actions: {
        signin:function() {
            ...
            Token.save().then(function(Token){
                ...
                console.log('-------------------------------------------');
                console.log('Access Token :'+Token.get('access_token'));
                console.log('Expiry :'+Token.get('expires_in'));
                console.log('Token Type :'+Token.get('token_type'));
                console.log('Scope :'+Token.get('scope'));
                console.log('Refresh Token :'+Token.get('refresh_token'));                
            },function(){
