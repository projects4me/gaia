...
class Config
{
    ...
    {
        // Loading all the files in core/config/
        return $this->di->get('fileHandler')->readFolder(APP_PATH.'/core/config/');
    }
    ...
    /**
     * This function is used to get the configuration against the given key.
     *
     * @method get
