...
namespace Gaia\Tests\Acl\AccessLevel1\WithRels1_1;

/**
 * This class is responsible to test the group model with access level 1 on both model and its relationships.
 * 
