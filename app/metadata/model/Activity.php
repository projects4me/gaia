    ...
    'triggers' => array(
        'addLastActivityDate' => array(
            ...
            'statement' => 'BEGIN
                                ...
                                UPDATE memberships as Membership SET Membership.lastActivityDate = NEW.dateCreated where Membership.relatedId = NEW.relatedId AND Membership.entity = "project" AND Membership.userId = NEW.createdUser;
                                END IF;
                            END;'
        )
    ),
