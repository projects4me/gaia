    ...
    'triggers' => array(
        'addLastActivityDate' => array(
            ...
            'statement' => 'BEGIN
                                ...
                                UPDATE memberships as Membership SET Membership.lastActivityDate = NEW.dateCreated where Membership.entityId = NEW.relatedId AND Membership.userId = NEW.createdUser;
                                END IF;
                            END;'
        )
    ),
